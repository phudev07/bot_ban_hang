...
def test_enabled_rentsim_requires_key_and_uses_cambodia_chatgpt_defaults() -> None:
    ...
    assert settings.rentsim_markup == 1_300
    assert settings.rentsim_fallback_price == 1_200
...
def test_enabled_autosms_requires_key_and_uses_us_chatgpt_defaults() -> None:
    ...
    assert settings.autosms_markup == 1_300
    assert settings.autosms_fallback_price == 1_200
