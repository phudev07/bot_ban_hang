...
export const TABLES = {
  ...
  apiKeys: {
    ...
    indexes: [
      ...
      "CREATE UNIQUE INDEX IF NOT EXISTS idx_ak_shop_order ON apiKeys(shopOrderId) WHERE shopOrderId IS NOT NULL",
    ],
  },
  apiKeyReservations: {
    columns: {
    ...
    indexes: [
      "CREATE INDEX IF NOT EXISTS idx_akr_key_status ON apiKeyReservations(apiKeyId, status)",
      "CREATE INDEX IF NOT EXISTS idx_akr_expiry ON apiKeyReservations(status, expiresAt)",
    ],
  },
  combos: {
    columns: {
